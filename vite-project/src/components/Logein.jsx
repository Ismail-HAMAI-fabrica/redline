                              ...
                              <div className="flex-auto w-[100%]  p-5  ">
                                 <div className="relative mb-3 mt-8">
                                      <label className='block uppercase text-blueGray-600 text-xs font-bold mb-2' >Username:</label>
                                       <input className='border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150' type="text" value={username} autoCapitalize='null' onChange={(e) => setUsername(e.target.value)} required />
                                </div>
