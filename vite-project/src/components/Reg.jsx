  ...
  return (
    <>
           <div className="bg-[#023047] flex flex-col justify-center gap-y-10 overflow-hidden ">
            ...
            <button onClick={() => navigate('/')} class="btn flex-1">
            <svg className='fill-white border-solid  border-2 p-1 border-white rounded-full w-14 hover:fill-amber-300 hover:border-white' xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 448 512"><path d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.2 288 416 288c17.7 0 32-14.3 32-32s-14.3-32-32-32l-306.7 0L214.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z"/></svg>
            </button>
                    ...
                    <section className=' relative block  lg:pt-0 bg-[#023047]'>
                      ...
                      <div className="container mx-auto px-4">
                          <div className="flex flex-wrap justify-items-stretch  ">
                            <div className=" pt-6 flex flex-wrap justify-center items-center gap-40">
                            <Animated/>
                              <div className="relative bg-white flex flex-col min-w-0 break-words w-[400px] mb-6 shadow-lg rounded-lg bg-blueGray-200">
