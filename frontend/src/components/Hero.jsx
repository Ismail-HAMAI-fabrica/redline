    ...
    <> 
      ...
      <div className='h-[100vh] bg-[#219EBC] w-full overflow-hidden'  style={{ position: 'relative' }}>
          ...
          <div className="absolute px-8 flex w-full  flex-col items-center sm:items-start z-10 top-14 sm:top-14 md:top-20 lg:top-36">
            ...
            <button onClick={() => navigate('/gallery')} type="button" className="text-white hover:text-lg hover:mr-8  mt-3 w-48 bg-[#FF9119] hover:bg-transparent font-medium rounded-bl-lg rounded-tr-lg  text-sm px-5 py-2.5 text-center inline-flex items-center  mr-2 mb-2">
              Discover Our Plans 
